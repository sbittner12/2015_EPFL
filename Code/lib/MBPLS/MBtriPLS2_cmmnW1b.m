function [Tb,W1b,W2b,Wt,Tt,Ub,Qb,Wu,Tu, ssx, ssy, W1b_temp, W2b_temp, Tu_orig] = MBtriPLS2_cmmnW1b(X,Y,nLV,tol)
...
for aa = 1:nbX
    ...
    DimX(1)
    prod(DimX(2:end))
    y = reshape(X{aa}, DimX(1), prod(DimX(2:end)));
    size(y)
